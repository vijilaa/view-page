...
const packages = [
    {
      ...
      data: {
        ...
        Electrical: [
          ...
          "<b>Dining:</b> 1 Switch Box (8-Module)",
          "<b>Pooja:</b> 1 Switch Box (3-Module)",
    ...
    },
    {
      ...
      data: {
        ...
        Structure: [
          ...
          "<b>Concrete Grade:</b> M20 | RMC for Roof",
          "<b>Ceiling Height:</b> 10 Feet",
          "<b>Steel Reinforcement:</b> As per Arvayon Structural Drawing",
        ...
        Electrical: [
          ...
          "<b>Dining:</b> 1 Switch Box (8-Module)",
          "<b>Pooja:</b> 2 Switch Box (3-Module)",
    ...
    },
    {
      ...
      data: {
        ...
        Structure: [
          ...
          "<b>Steel Reinforcement:</b> 1.5 times Strength as per Arvayon Structural Drawings",
